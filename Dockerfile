...
RUN Rscript -e "options(warn=2); install.packages(c('codetools', 'dplyr', 'gen3sis', 'gdistance', 'ggplot2', 'Matrix', 'raster', 'rgdal', 'remotes'), repos='http://cran.rstudio.com/', verbose=TRUE); library(remotes); install_github('cran/rgdal', quiet=FALSE);"
